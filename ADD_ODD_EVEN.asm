...
MOV C,M		;C<-M
MVI D,00H	;Used to Store Sum Of Odd No
MVI E,00H	;Used to Store Sum Of Even No
...
MOV A,D		;A<-D
STA 000DH	;Store Accumulator Value to 000DH Location
MOV A,E		;A<-E
STA 000EH	;Store Accumulator Value to 000EH Location
hlt		;Stop